...
export const metadata: Metadata = {
  ...
  description: 'Ascend MY privacy policy. How we collect, use, and protect your personal information when you shop for research peptides.',
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose-custom">
        <p>
          Ascend MY (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) respects your privacy. This Privacy Policy explains how we collect, use, and protect your personal information when you visit our website (ascendpeptides.my) or make a purchase.
        </p>
        ...
        <p>We do not collect sensitive financial information such as credit card numbers. Online payments are processed through third-party payment gateways (Billplz) which have their own privacy policies.</p>
        ...
        <h2>Contact</h2>
        <p>
          For privacy-related inquiries, contact us via <a href="https://wa.me/601161092723" target="_blank" rel="noopener noreferrer" className="underline">WhatsApp</a>.
        </p>
      </div>
    </div>
  );
