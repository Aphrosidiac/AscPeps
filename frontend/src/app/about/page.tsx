        ...
        <Animate variant="scale" duration={0.6}>
          <div className="bg-primary text-white rounded-2xl p-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a href="https://www.tiktok.com/@ascendpeptidesmy" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 border border-neutral-600 text-white font-medium px-6 py-3 rounded-lg hover:bg-white/10 transition-colors">
